...
export function Header() {
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[1269px] flex-col items-start gap-4 border-border py-4 tablet:h-[100px] tablet:flex-row tablet:items-center tablet:justify-between tablet:gap-6 desktop:border-x desktop:px-10 desktop:py-0">
